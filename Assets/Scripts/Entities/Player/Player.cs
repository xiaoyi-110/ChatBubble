...
public class Player : Entity
{
    ...
    protected override void Awake()
    {
        ...
        m_Fsm = Fsm<Player>.Create(
            "player",
            this,
            new PlayerIdleState("Idle"),
            new PlayerMoveState("Move"),
            new PlayerJumpState("JumpFall"),
            new PlayerAirState("JumpFall"),
            new PlayerAttackState("Attack")
        );
    }
    ...
    {
        base.Update();
        m_Fsm.Update(Time.deltaTime, Time.time);  
    }
